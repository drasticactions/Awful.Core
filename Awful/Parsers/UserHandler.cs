...
namespace Awful.Parsers
{
    ...
    {
        public static void ParseFromUserProfile(ProfileUser user, string html)
        {
        ...
        public static void ParseFromUserProfile(ProfileUser user, HtmlNode profileNode, HtmlNode threadNode)
        {
